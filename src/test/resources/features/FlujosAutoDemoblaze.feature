...
Característica: Registrar y logearme con un usuario de alta y realizar actividades dentro de la web
  ...
  Escenario:
    ...
    Cuando ingreso mis credenciales para dar mi alta de usuario con user y pass :"brandon10337" , "123123"
    Y me logeo al pagina con el usuario dado de dalta con el user y pass registrados: "brandon10337", "123123"
  ...
  Escenario:
    Dado Que me encuentro en la pagina de demoblaze
    Cuando me logeo al pagina con el usuario dado de dalta con el user y pass registrados: "brandon10337", "123123"
    Entonces valida la pantalla de ingreso con Welcome :"Welcome"
